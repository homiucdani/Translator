package com.example.translator.core.domain.presentation
...
// we need this cuz on the ui we have the image vectors, which we cannot save into db only if we compress the bytes i guess
data class UiLanguage(
    @DrawableRes val drawableRes: Int,
    val language: Language
) {

    // this is for the tts cuz we wanna hear different voices
    fun toLocale(): Locale? {
